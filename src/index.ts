...
export class CodeGraph {
  ...
  /**
   * True when the file watcher has debounced or in-flight source sync work.
   * Semantic ObjC enrichment uses this to avoid enriching against a source graph
   * that is about to be updated by the normal tree-sitter watcher.
   */
